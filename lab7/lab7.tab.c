...
int LEVEL = 0; //how may ocmpound statements deep we are in 
...
{
       0,    87,    87,    93,    97,   104,   106,   110,   123,   140,
     155,   170,   186,   187,   188,   192,   208,   191,   224,   226,
     230,   232,   237,   253,   269,   269,   283,   288,   292,   293,
     299,   301,   303,   305,   307,   309,   311,   313,   317,   320,
     324,   330,   341,   348,   364,   368,   374,   379,   384,   408,
     439,   443,   445,   461,   462,   463,   464,   465,   466,   469,
     471,   489,   490,   493,   495,   510,   511,   512,   513,   516,
     518,   523,   526,   528,   530,   544,   548,   554,   585,   588,
     591,   599
};
#endif
...
#line 1272 "lab7.tab.c"
    break;

  case 5: /* Declaration: Var_Declaration  */
#line 105 "lab7.y"
                {(yyval.node) = (yyvsp[0].node);}
#line 1278 "lab7.tab.c"
    break;

  case 6: /* Declaration: Fun_Declaration  */
#line 107 "lab7.y"
                {(yyval.node) = (yyvsp[0].node);}
#line 1284 "lab7.tab.c"
    break;
...
#line 1433 "lab7.tab.c"
    break;

  case 18: /* Params: T_VOID  */
#line 225 "lab7.y"
        {(yyval.node) = NULL;}
#line 1439 "lab7.tab.c"
    break;

  case 19: /* Params: Param_List  */
#line 227 "lab7.y"
        {(yyval.node) = (yyvsp[0].node);}
#line 1445 "lab7.tab.c"
    break;

  case 20: /* Param_List: Param  */
#line 231 "lab7.y"
            {(yyval.node) = (yyvsp[0].node);}
#line 1451 "lab7.tab.c"
    break;
...
#line 1496 "lab7.tab.c"
    break;

  case 24: /* $@3: %empty  */
#line 269 "lab7.y"
                          {LEVEL++;}
#line 1502 "lab7.tab.c"
    break;
...
#line 284 "lab7.y"
                        {(yyval.node) = ASTCreateNode(A_DECLARATION_LIST);
                         (yyval.node) -> s1 = (yyvsp[-1].node);
                         (yyval.node) -> s2 = (yyvsp[0].node);}
#line 1525 "lab7.tab.c"
    break;

  case 27: /* Local_Declarations: %empty  */
#line 288 "lab7.y"
                    {(yyval.node) = NULL;}
#line 1531 "lab7.tab.c"
    break;

  case 28: /* Statement_List: %empty  */
#line 292 "lab7.y"
                {(yyval.node) = NULL;}
#line 1537 "lab7.tab.c"
    break;
...
#line 318 "lab7.y"
                {(yyval.node) = ASTCreateNode(A_EXPR_STMT);
                 (yyval.node) -> s1 = (yyvsp[-1].node);}
#line 1600 "lab7.tab.c"
    break;

  case 39: /* Expression_Stmt: ';'  */
#line 321 "lab7.y"
                {(yyval.node) = NULL;}
#line 1606 "lab7.tab.c"
    break;
...
#line 446 "lab7.y"
                    {
                     ...
                     (yyval.node) -> symbol = Insert(CreateTemp(), (yyval.node) -> datatype, SYM_SCALAR, LEVEL, 1, OFFSET);
                     OFFSET += 1;}
#line 1777 "lab7.tab.c"
    break;

  case 53: /* Rel_Op: T_LE  */
#line 461 "lab7.y"
               { (yyval.operator) = A_LE; }
#line 1783 "lab7.tab.c"
    break;

  case 54: /* Rel_Op: T_LT  */
#line 462 "lab7.y"
               { (yyval.operator) = A_LT; }
#line 1789 "lab7.tab.c"
    break;

  case 55: /* Rel_Op: T_GT  */
#line 463 "lab7.y"
               { (yyval.operator) = A_GT; }
#line 1795 "lab7.tab.c"
    break;

  case 56: /* Rel_Op: T_GE  */
#line 464 "lab7.y"
               { (yyval.operator) = A_GE; }
#line 1801 "lab7.tab.c"
    break;

  case 57: /* Rel_Op: T_EQ  */
#line 465 "lab7.y"
               { (yyval.operator) = A_EQ; }
#line 1807 "lab7.tab.c"
    break;

  case 58: /* Rel_Op: T_NE  */
#line 466 "lab7.y"
               { (yyval.operator) = A_NE; }
#line 1813 "lab7.tab.c"
    break;

  case 59: /* Additive_Expression: Term  */
#line 470 "lab7.y"
                    {(yyval.node) = (yyvsp[0].node);}
#line 1819 "lab7.tab.c"
    break;
...
#line 472 "lab7.y"
                    {
                     ...
                     OFFSET += 1;}
#line 1838 "lab7.tab.c"
    break;

  case 61: /* Add_Op: '+'  */
#line 489 "lab7.y"
              {(yyval.operator) = A_PLUS;}
#line 1844 "lab7.tab.c"
    break;

  case 62: /* Add_Op: '-'  */
#line 490 "lab7.y"
              {(yyval.operator) = A_MINUS;}
#line 1850 "lab7.tab.c"
    break;

  case 63: /* Term: Factor  */
#line 494 "lab7.y"
        {(yyval.node) = (yyvsp[0].node);}
#line 1856 "lab7.tab.c"
    break;
...
#line 496 "lab7.y"
        {
          ...
          (yyval.node)->symbol = Insert(CreateTemp(), (yyvsp[-2].node)->datatype, SYM_SCALAR, LEVEL, 1,OFFSET);
          OFFSET = OFFSET + 1;}
#line 1873 "lab7.tab.c"
    break;

  case 65: /* Mult_Op: '*'  */
#line 510 "lab7.y"
              {(yyval.operator) = A_TIMES;}
#line 1879 "lab7.tab.c"
    break;

  case 66: /* Mult_Op: '/'  */
#line 511 "lab7.y"
              {(yyval.operator) = A_DIVIDE;}
#line 1885 "lab7.tab.c"
    break;

  case 67: /* Mult_Op: T_AND  */
#line 512 "lab7.y"
               {(yyval.operator) = A_AND;}
#line 1891 "lab7.tab.c"
    break;

  case 68: /* Mult_Op: T_OR  */
#line 513 "lab7.y"
              {(yyval.operator) = A_OR;}
#line 1897 "lab7.tab.c"
    break;

  case 69: /* Factor: '(' Expr ')'  */
#line 517 "lab7.y"
        {(yyval.node) = (yyvsp[-1].node);}
#line 1903 "lab7.tab.c"
    break;
...
#line 524 "lab7.y"
        {(yyval.node) = ASTCreateNode(A_STRING);
         (yyval.node)-> name = (yyvsp[0].string);}
#line 1919 "lab7.tab.c"
    break;

  case 72: /* Factor: VARIABLE  */
#line 527 "lab7.y"
        {(yyval.node) = (yyvsp[0].node);}
#line 1925 "lab7.tab.c"
    break;

  case 73: /* Factor: CALL  */
#line 529 "lab7.y"
        {(yyval.node) = (yyvsp[0].node);}
#line 1931 "lab7.tab.c"
    break;
...
#line 1998 "lab7.tab.c"
    break;

  case 78: /* Args: Arg_list  */
#line 586 "lab7.y"
        {(yyval.node) = (yyvsp[0].node);}
#line 2004 "lab7.tab.c"
    break;

  case 79: /* Args: %empty  */
#line 588 "lab7.y"
        {(yyval.node) = NULL;}
#line 2010 "lab7.tab.c"
    break;
...
#line 600 "lab7.y"
                {(yyval.node) = ASTCreateNode(A_ARG_LIST);
                 ...
                 OFFSET += 1;}
#line 2034 "lab7.tab.c"
    break;


#line 2038 "lab7.tab.c"
